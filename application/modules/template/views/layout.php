        ...
        <div class="content-wrapper">
                    ...
                    <div class="content-header row align-items-center mb-4">
                        ...
                        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-1 mb-sm-0 p-0 ">
                            ...
                            <ol class="breadcrumb d-inline-flex font-weight-500 fs-13 bg-white mb-0">
                                <li class="breadcrumb-item"><?php $str = display('home');
                                                            echo strtoupper($str); ?></a>
                                </li>
                                <?php if ($this->uri->segment(2) && $this->uri->segment(1) != 'edit-phrase') { ?>
                                <li class="breadcrumb-item">
                                    <?php $str1 = explode('_', $this->uri->segment(1));
                                    echo strtoupper($str1[0]) ?></a>
                                </li>
                                <?php } else { ?>
                                <li class="breadcrumb-item">
                                    <?php $str1[0] = display('dashboard');
                                    echo strtoupper($str1[0]) ?></a></li>
                                <?php } ?>
                                <?php $str2 = explode('_', $this->uri->segment(2));
                                if (strtoupper($str) != strtoupper($str1[0]) && strtoupper($str) != strtoupper($str2[0])) { ?>
                                <li class="breadcrumb-item active">
                                    <?php $str2 = explode('_', $this->uri->segment(2));
                                    echo (!empty($title) ? strtoupper($title) : (!empty($str2[0]) ? strtoupper(str_replace("-", " ", $str2[0])) : strtoupper(str_replace("-", " ", $this->uri->segment(1))))) ?></a>
                                </li>
                                <?php } ?>
                            </ol>
                            <?php } ?>
            ...
            <footer class="footer-content">
                <div class="footer-text d-flex align-items-center justify-content-between">
                    ...
                    <div class="credit">
                        <?php echo html_escape((!empty($setting->address) ? $setting->address : null)) ?>
                    </div>
                </div>
            </footer>
            <!--/.footer content-->
