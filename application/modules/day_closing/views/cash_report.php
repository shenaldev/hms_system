    ...
    <table class="table table-bordered table-striped table-hover" id="respritbl">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php $counterno = $this->db->select("counterno")->from("tbl_cashcounter")->where("ccid",$item->counter_no)->get()->row(); ?>
                <td><?php echo $counterno->counterno;?></td>
                <td align="right"><?php echo $item->opening_balance;?></td>
                <td align="right"><?php echo $item->closing_balance;?></td>
                <td><a href="javascript:;"
                        onclick="detailscash('<?php echo $item->opendate;?>','<?php echo $item->closedate;?>',<?php echo $item->userid;?>)"
        ...
        <tfoot class="cash-report-footer">
            <tr>
                <td class="cash-report-total" colspan="4" align="right">&nbsp; <b><?php echo display('total') ?> </b>
                </td>
