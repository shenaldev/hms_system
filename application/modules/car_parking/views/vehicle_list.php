                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="vehicle_type"
                                            class="col-sm-4 col-form-label"><?php echo display("vehicle_type") ?>
                                            <span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <input name="vehicle_type" autocomplete="off" class="form-control" type="text"
                                                placeholder="<?php echo display("vehicle_type") ?>" id="vehicle_type" value=""
                                                required>
                                        </div>
                                    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card-header">
                <h4><?php echo display('vehicle_list') ?><small
            ...
            <div class="card-body">
                <table width="100%" id="exdatatable" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                        <?php $sl = 1; ?>
                        <?php foreach ($vehicle_details as $dtype) { ?>
                        <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                            <td><?php echo $sl; ?></td>
                            <td><?php echo html_escape($dtype->vehicle_type); ?></td>
                            </td>
                            <td class="center">
                                <?php if($this->permission->method('car_parking','update')->access()): ?>
                                <input name="url" type="hidden" id="url_<?php echo html_escape($dtype->vehicle_id); ?>"
                                    value="<?php echo base_url("car_parking/car_parking/vehicleList") ?>" />
                                <a onclick="editcarParking('<?php echo html_escape($dtype->vehicle_id); ?>')"
                                ...
                                <a href="<?php echo base_url("car_parking/car_parking/vehicleDelete/".html_escape($dtype->vehicle_id)) ?>"
