                ...
                <div class="card-body">
                    <div class="col-md-12">
                            ...
                            <div id="lextleftinvoice" class="col-md-4 " >
                                ...
                                <div><?php echo display('order_status') ?>:
                            ...
                            <tbody>
                                <?php $i=0; 
								  $totalamount=0;
									...
									foreach ($iteminfo as $item){
									 ...
									 ?>
                                <tr>
                                    <td class="text-right" colspan="4"><strong><?php echo display('subtotal')?></strong>
                                    </td>
                                    <td class="text-right">
                                        <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
                                            <?php echo $itemtotal;?>
                                ...
                                <tr>
                                    <td class="text-right" colspan="4">
                                        <strong><?php echo display('discount')?><?php if(!empty($discountpr)){echo $discountpr;}?></strong></td>
                                    <td class="text-right">
                                        <strong><?php if($currency->position==1){echo $currency->curr_icon;}?>
