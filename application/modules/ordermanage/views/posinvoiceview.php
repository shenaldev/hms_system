...
<div class="page-wrapper">
    ...
    <div class="invoice-card">
        <div class="invoice-head">
            ...
            <h4><?php echo $storeinfo->storename ? $storeinfo->storename : 'Store'; ?></h4>
        ...
        <div class="invoice_address">
            <div class="row-data">
                ...
                <?php if ($storeinfo->isvatnumshow == 1) { ?><h5 class="item-title"><?php echo display('tinvat'); ?><?php if (!empty($storeinfo->vattinno)) {
                                                                                                                        echo ': ' . $storeinfo->vattinno;
                                                                                                                    } ?></h5><?php } ?>
            </div>
        </div>
            ...
            <div class="invoice-list">
                ...
                <div class="invoice-data">
                    ...
                    foreach ($iteminfo as $item) {
                        ...
                        // Determine item price based on availability
                        if ($item->price > 0) {
                        ...
                        // Get item details and calculate discounts
                    ...
                    // Get service charge
                    $servicecharge = empty($billinfo) ? 0 : $billinfo->service_charge;

                    // Format service charge display
                    $sdr = '';
                    ...
                    // Get discount
                    $discount = empty($billinfo) ? 0 : $billinfo->discount;

                    // Format discount display
                    $discountpr = '';
                    if (!empty($storeinfo->discount_type) && $storeinfo->discount_type == 1) {
        ...
        <div class="invoice-footer mb-15">
            ...
            <div class="row-data">
                ...
                <h5 class="my-5"> <?php if ($billinfo->bill_status == 1) {
        ...
        <div class="invoice_address">
            ...
            <div class="middle-data">
                <div class="item-info gap_right">
                    <h5 class="item-title"><?php echo display('table'); ?>: <?php if (!empty($tableinfo)) {
            ...
            <div class="text-center">
                ...
                <p class="b_top"><?php echo 'Iringa Sunset Hotel' ?></p>
            </div>
        </div>
    </div>
</div>