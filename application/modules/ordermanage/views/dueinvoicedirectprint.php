...
<body>
  <div class="page-wrapper">
    <div class="invoice-card">
      <div class="invoice-head"> <img src="<?php echo base_url(); ?><?php echo (file_exists($comsettinginfo->invoice_logo) ? $comsettinginfo->invoice_logo : 'application/modules/ordermanage/assets/images/dum_ordermanage_ivc.png') ?>" alt="">
      ...
      <div class="invoice_address">
        <div class="row-data">
          ...
          <?php if ($storeinfo->isvatnumshow == 1) { ?>
            <h5 class="item-title"><?php echo display('tinvat'); ?><?php if (!empty($storeinfo->vattinno)) {
