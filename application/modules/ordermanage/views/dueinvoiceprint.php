...
<div id="printableArea" class="bill__container bill-pos-mini__container width-font">
    ...
    <div class="px-4">
            ...
            <table class="w-100">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td class="p-0">
                                <p class="mb-0"><?php echo $item->ProductName; ?>-<?php echo $item->variantName; ?></p><small class="mb-0 text-italic"><?php echo $item->price; ?> x <?php echo $item->menuqty; ?></small>
                            </td>
                            <td valign="top" class="p-0 text-right">
                                <p class="mb-0"><?php if ($currency->position == 1) {
                                                    echo $currency->curr_icon;
                                                } ?> <?php echo $itemprice - $ptdiscount; ?> <?php if ($currency->position == 2) {
                                                                                                                                                        echo $currency->curr_icon;
                                                                                                                                                    } ?></p>
                            </td>
                        </tr>
                            ...
                            foreach ($addons as $addonsid) {
                                ...
                                <tr>
                                    <td valign="top" class="p-0">
                                        <p class="mb-0 ml-2">-<?php echo $adonsinfo->add_on_name; ?></p><small class="mb-0 ml-2 text-italic"><?php echo $adonsinfo->price; ?> x <?php echo $addonsqty[$y]; ?></small>
                                    </td>
                                    <td valign="top" class="text-right"><?php if ($currency->position == 1) {
                                                                            echo $currency->curr_icon;
        ...
        <div class="border-bottom--dashed">
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary text-bold"><?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                    } ?> <?php echo $billinfo->total_amount; ?> <?php if ($currency->position == 2) {
                                                                                                                                                                            echo $currency->curr_icon;
                                                                                                                                                                        } ?></p>
            </div>
            <div class="d-flex justify-content-between align-items-center mb-2">
                <p class="mb-0 text-note text-primary"><?php echo display('discount') ?></p>
                <p class="mb-0 text-note text-primary">-<?php if ($currency->position == 1) {
                                                            echo $currency->curr_icon;
                                                        } ?> <?php $discount = 0;
                                                                                                                        if (empty($billinfo)) {
                                                                                                                            echo $discount;
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary"><?php if ($currency->position == 1) {
                                                            echo $currency->curr_icon;
                                                        } ?> <?php echo $calvat = $billinfo->VAT; ?> <?php if ($currency->position == 2) {
                                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                                            } ?></p>
            </div>
        </div>
        <div class="border-bottom--dashed">
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="mb-0 text-note text-primary text-bold"><?php if ($currency->position == 1) {
                                                                        echo $currency->curr_icon;
                                                                    } ?> <?php echo $billinfo->bill_amount; ?> <?php if ($currency->position == 2) {
                                                                                                                                                                            echo $currency->curr_icon;
                                                                                                                                                                        } ?></p>
            </div>
            <?php
            ...
            if ($billinfo->bill_status == 1) { ?>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <p class="mb-0 text-note text-primary"><?php if ($currency->position == 1) {
                                                                echo $currency->curr_icon;
                                                            } ?> <?php echo $customepaid; ?> <?php if ($currency->position == 2) {
                                                                                                                                                            echo $currency->curr_icon;
                                                                                                                                                        } ?></p>
                </div>
            <?php } else { ?>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <p class="mb-0 text-note text-primary"><?php if ($currency->position == 1) {
                                                            echo $currency->curr_icon;
                                                        } ?> <?php echo $changes; ?> <?php if ($currency->position == 2) {
                                                                                                                                                    echo $currency->curr_icon;
                                                                                                                                                } ?></p>
            </div>
        </div>
        <div class="">
            <div class="d-flex justify-content-between">
                ...
                <?php if ($billinfo->bill_status == 1) { ?><p class="mb-0 text-note"><?php if ($currency->position == 1) {
                                                                                    echo $currency->curr_icon;
                                                                                } ?> <?php echo $customepaid; ?> <?php if ($currency->position == 2) {
                                                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                                                            } ?></p>
                <?php } else { ?><p class="mb-0 text-note"><?php if ($currency->position == 1) {
                                                                echo $currency->curr_icon;
                                                            } ?> <?php echo 0.00; ?> <?php if ($currency->position == 2) {
                                                                                                                                                echo $currency->curr_icon;
                                                                                                                                            } ?></p><?php } ?>
            </div>
        </div>
    ...
    <div class="border-top py-1">
        ...
        <p class="text-note text-primary text-center mb-0">Powered By Fortxcore.com</p>
    </div>
</div>