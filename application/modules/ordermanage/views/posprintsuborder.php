            ...
            <div class="invoice-footer mb-15">
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        } ?> <?php echo $total; ?> <?php if ($currency->position == 2) {
                                                                                                                                echo $currency->curr_icon;
                                                                                                                            } ?></h5>
                </div>
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        } ?> <?php echo $vat; ?> <?php if ($currency->position == 2) {
                                                                                                                            echo $currency->curr_icon;
                                                                                                                        } ?></h5>
                </div>
                <div class="row-data">
                ...
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        } ?> <?php echo $alldiscount; ?> <?php if ($currency->position == 2) {
                                                                                                                                    echo $currency->curr_icon;
                                                                                                                                } ?></h5>
                </div>
                ...
                <div class="row-data border-top">
                    ...
                    <h5 class="my-5"><?php if ($currency->position == 1) {
                                            echo $currency->curr_icon;
                                        } ?> <?php echo $gtotal; ?> <?php if ($currency->position == 2) {
                                                                                                                                echo $currency->curr_icon;
                                                                                                                            } ?></h5>
                </div>
            </div>
